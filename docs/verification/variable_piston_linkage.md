...
- Piston head travel is bounded so two- and three-body engines do not animate into the floor or ceiling at the bottom of the stroke.
...
- [ ] Confirm intermediate piston bodies do not briefly switch correctly and then revert after nearby engine validation runs.
- [ ] Confirm two- and three-body piston heads stay inside the cylinder/floor envelope through a full animation cycle.
- [ ] Confirm upside-down two- and three-body piston heads stay inside the cylinder/ceiling envelope through a full animation cycle.
