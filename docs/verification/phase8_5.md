...
- Refactored engine validation around stroke direction while preserving upright pipe-fed behavior.
...
- [ ] Upright and upside-down engines do not run from an adjacent boiler and only run from piped steam.
