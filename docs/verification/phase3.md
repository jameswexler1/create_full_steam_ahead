...
- [ ] Complete a 3x3x2 hollow cylinder ring and confirm all 16 blocks change to the assembled placeholder model.
- [ ] Break one cylinder block and confirm the remaining ring disassembles.
- [ ] Fill a center position with a non-piston block and confirm the ring does not assemble.
- [ ] Build the ring above a 3x3 Create Fluid Tank layer and confirm goggles show boiler linked.
- [ ] Build the ring without tanks below and confirm goggles show no steam source.
- [ ] Save and reload the world and confirm the ring revalidates.
