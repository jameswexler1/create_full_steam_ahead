...
public final class FullSteamConfig {
    ...
    private static final double DEFAULT_OVERPRESSURE_POWER_SCALE = 1.0D;
    ...
    static {
        ...
        OVERPRESSURE_POWER_SCALE = builder
                .comment("Final multiplier applied to boiler burst explosion power.",
                        "Default 1.0 preserves the base/per-volume tuning curve while making bursts 200% as strong as the old 0.5 scale.")
