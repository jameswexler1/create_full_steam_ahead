...
public final class CylinderRingShapes {
    ...
    private static final RingBox[] ASSEMBLED_BOXES = {
            ...
            new RingBox(-2, 0, 16, 18, 31, 25),
            new RingBox(-2, 0, -9, 18, 31, 0),
            ...
            new RingBox(-2, 31, -8, 18, 32, 0),
            new RingBox(-2, 31, 16, 18, 32, 24),
            new RingBox(18, 31, -2, 24, 32, 18),
            new RingBox(-8, 31, -2, -2, 32, 18),
            new RingBox(-2, 31, 0, 0, 32, 16),
            new RingBox(16, 31, 0, 18, 32, 16),
            new RingBox(18, 31, 18, 22, 32, 20),
            new RingBox(18, 31, -4, 22, 32, -2),
            new RingBox(-6, 31, 18, -2, 32, 20),
            new RingBox(-6, 31, -4, -2, 32, -2),
            new RingBox(-4, 31, -6, -2, 32, -4),
            ...
            new RingBox(-6, 0, -4, -2, 1, -2),
            new RingBox(-4, 0, -6, -2, 1, -4),
