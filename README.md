...
- Boiler-mounted `steam_relief_valve` blocks protect the physical Create Fluid Tank boiler they sit on. They auto-open at `2.2 MpN/m²`, close below `1.7 MpN/m²`, have a `720 mB/t` baseline vent rate, scale relief authority with active boiler production once open, and can be forced open with redstone.
