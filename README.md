...
- When Create Aeronautics is installed, powered `aeronautics:steam_vent` blocks mounted on FSA-fed boilers consume FSA steam proportional to their live Aeronautics gas output. The default conversion is `5000 m³ -> 10 mB/t`, controlled by `aeronauticsCompat.steamVentMbPerM3`.
